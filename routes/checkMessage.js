...
router.get('/', function(req, res) {
    ...
    if (!req.cookies["userName"]) {
        ...
        if (req.query.action == "clear") {
            ...
            res.render('awardList.ejs', {
                weixinWheelAward: global.luckyAwardUsers.weixinWheelAward,
                ticketWheelAward: global.luckyAwardUsers.ticketWheelAward,
                allUserInfo: global.allUserInfo
            });
            return;
        }

        res.render('checkMessageList.ejs', {
            messageList: global.messagePendingCheckList,
            systemNums: global.getSystemNums(),
            severInfo: global.severInfo
        });
    }
...
router.get("/allUsers", function(req, res) {
    res.render('allUsers.ejs', {
        allUserInfo: global.allUserInfo,
        messageCheckedList: global.messageCheckedList
    });
});
router.get("/deleted", function(req, res) {
    res.render('deletedMessageList.ejs', {
        allUserInfo: global.allUserInfo,
        deletedMessageList: global.deletedMessageList
    });
});
